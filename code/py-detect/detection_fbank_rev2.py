...
from Antenna_rev2 import Antenna
...
while True:
    ...
    if antennaY_flag == False:
        if antennaY.detection() == True:
            ...
            #print("Y-test: " + str(y_sig_str_dB))
  

    if antennaX_flag == True and antennaY_flag == True:
        print("")
        print("Antenna X signal strength: " + str(x_sig_str_dB) + " dBm, located in filter " + str (x_sig_filter))
        #print("Antenna X signal power: " + str(x_sig_str))
        #print("Antenna X meas_ctr: " + str(x_sig_meas_ctr))
        #print("")
        print("Antenna Y signal strength: " + str(y_sig_str_dB) + " dBm, located in filter " + str (y_sig_filter))
        ...
        #print("Antenna Y signal power: " + str(y_sig_str))
        #print("Antenna Y meas_ctr: " + str(y_sig_meas_ctr))
    
        # Report and send data over UART / I2C
