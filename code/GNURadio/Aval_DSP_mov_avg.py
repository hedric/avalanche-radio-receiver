...
# Title: Aval Dsp Mov Avg
# Generated: Mon Nov 19 13:20:20 2018
##################################################
...
class Aval_DSP_mov_avg(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="Aval Dsp Mov Avg")
...
def main(top_block_cls=Aval_DSP_mov_avg, options=None):
